...
TEST_COMPONENT(002)
{
    ...
    const std::vector<str_w> etalon_w = 
    { 
...
TEST_COMPONENT(007)
{
    ...
    const std::vector<wchar_t> etalon_p = { L';', L';' };
...
TEST_COMPONENT(008)
{
    ...
    const std::vector<str_w> etalon_w = { L"", L"", L"" };
    const std::vector<wchar_t>  etalon_p = { L';', L';'    };
